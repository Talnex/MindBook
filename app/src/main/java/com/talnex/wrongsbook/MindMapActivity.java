...
import com.talnex.wrongsbook.Models.nodechild;
...
public class MindMapActivity extends AppCompatActivity {
    ...
    /**
     *
     * @param button_y 当前节点x坐标
     * @param button_x 当前节点的y坐标
     * @param line_x 线条x坐标
     * @param tree_current 树高，即层级
     * @param nc 下层节点
     * @param nodeid 业务中遇到的，代码中可以忽略
     */
...
//        得到下一级第一个按钮的y坐标
        ...
        if (button_y < tree_xnum[tree_current]) {
            button_y = tree_xnum[tree_current] + 100;//强制下移
        }
//        移动当前布局到页面中心
...
//            把button通过布局add到页面里
            ...
            insertLayout.setBackgroundColor(ColorUtils.getRandColor());
